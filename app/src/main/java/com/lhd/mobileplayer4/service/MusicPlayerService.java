package com.lhd.mobileplayer4.service;
...
{
    public static final String OPENAUDIO = "open_audio";
    /**
     * 顺序播放
     */
    ...
    private void openAudio(int position)
    {
        ...
        {
            Toast.makeText(MusicPlayerService.this, "还没有传入音乐列表", Toast.LENGTH_SHORT).show();
        }
...
//            notifyChange(OPENAUDIO);
    ...
    private void start()
    {
        ...
        notification = new Notification.Builder(this).setSmallIcon(R.drawable
                .notification_music_playing).setContentTitle("321音乐").setContentText("正在播放:" +
                                                                                     getName())
    ...
    private void getDataFromLocal()
    {
        ...
        new Thread()
        {
            ...
            public void run()
            {
                ...
                String[] objs = {MediaStore.Audio.Media.DISPLAY_NAME,//视频文件在sdcard的名称
