...
import com.lhd.mobileplayer4.domain.Lyric;
import com.lhd.mobileplayer4.utils.DensityUtils;
...
public class ShowLyricView extends TextView {
    ...
    private void initView(Context context) {
        textHeight = DensityUtils.dip2px(context, 18);//对应的像数
        LogUtil.e("textHeight==" + textHeight);
        //创建画笔
        paint = new Paint();
        paint.setColor(Color.GREEN);
        paint.setTextSize(DensityUtils.dip2px(context,16));
